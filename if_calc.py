...
"""
Pour une famille, SMILES HBA/HBD et ratio, on construit le vecteur ayant le format accepté pour prédire dans IsolationForest
On prédit le résutat de si oui on non c'est potentiellement un DES ainsi que le score avec ce vecteur
si c'est potentiellement un DES, ou renvoie le score  
"""
...
if __name__ == '__main__':
    ...
    Pour chaque HBA
        Pour chaque HBD
            Pour tout ratio allant de 0.1:0.9 à 0.9:0.1
                On évalue le couple HBA/HBD/ratio
                Pour le meilleur ratio, si c'est potentiellement un DES, on le note dans le fichier
    """
